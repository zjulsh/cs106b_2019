...
bool help(const HashMap<std::string, HashSet<std::string>>& roadNetwork,
          int numCities,
          HashSet<std::string>& supplyLocations);

bool judge(const HashMap<std::string, HashSet<std::string>>& roadNetwork,
           HashSet<std::string>& supplyLocations);

bool judgeNeighbor(std::string name,
                   const HashMap<std::string, HashSet<std::string>>& roadNetwork,
                   HashSet<std::string>& supplyLocations);
#endif
