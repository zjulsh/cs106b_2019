...
const std::vector<GUI::GUIOption> _kGUIOptions = {
    ...
    GUI_HANDLER("Interactive Sierpinski", makeInteractiveSierpinskiGUI),
    GUI_HANDLER("Sierpinski Bungee Jump", makeBungeeJumpGUI),
    GUI_HANDLER("Human Pyramids",         makePyramidGUI),
    GUI_HANDLER("What Are You Doing",     makeWhatAreYouDoingGUI),
    GUI_HANDLER("Shift Scheduling",       makeShiftSchedulingGUI),
};
